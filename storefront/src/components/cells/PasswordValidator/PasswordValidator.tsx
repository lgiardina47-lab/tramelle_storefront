    ...
    <Card className="p-4">
      <p
        className={cn(
          ...
          newPasswordError['8chars'] ? 'text-red-700' : 'text-neutral-900'
        )}
      >
      ...
      <p
        className={cn(
          'label-md mb-2 flex items-center gap-2',
          newPasswordError['lower'] ? 'text-red-700' : 'text-neutral-900'
        )}
      >
      ...
      <p
        className={cn(
          'label-md mb-2 flex items-center gap-2',
          newPasswordError['upper'] ? 'text-red-700' : 'text-neutral-900'
        )}
      >
      ...
      <p
        className={cn(
          'label-md mb-2 flex items-center gap-2',
          newPasswordError['digit'] ? 'text-red-700' : 'text-neutral-900'
        )}
      >
      ...
      <p
        className={cn(
          'label-md mb-2 flex items-center gap-2',
          newPasswordError['symbol'] ? 'text-red-700' : 'text-neutral-900'
        )}
      >
