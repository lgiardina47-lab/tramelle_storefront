...
import { InlineTip, Input, Label, ProgressTabs, Select, Switch, Text, Textarea, toast } from '@medusajs/ui';
import {
  FormProvider,
  useForm,
  useWatch,
...
export const AttributeForm = forwardRef<AttributeFormRef, AttributeFormProps>(
  (
    ...
    const resolver = useMemo((): Resolver<CreateFormValues | UpdateFormValues> => {
      if (mode === "create") {
        return zodResolver(
          CreateAttributeFormSchema
        ) as Resolver<CreateFormValues | UpdateFormValues>
      }
      return zodResolver(
        UdpateAttributeFormSchema
      ) as Resolver<CreateFormValues | UpdateFormValues>
    }, [mode])
    ...
    return (
      <FormProvider {...form}>
        ...
        >
          ...
          <ProgressTabs.Content value="type">
            {renderTypeTab()}
          </ProgressTabs.Content>
        </form>
      </FormProvider>
