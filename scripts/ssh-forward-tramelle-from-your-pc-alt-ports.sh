...
# mappa su porte locali libere → stesse porte sulla VPS.
#
# Uso:
#   bash scripts/ssh-forward-tramelle-from-your-pc-alt-ports.sh root@HOST
#
# Poi sul browser del PC:
#   http://127.0.0.1:13000/it   — storefront (VPS :3000)
#   http://127.0.0.1:17000      — admin (VPS :7000)
#   http://127.0.0.1:15173      — vendor (VPS :5173)
# Le app che chiamano http://127.0.0.1:9000 dal browser devono poter usare :19000
# se non hai anche forwardato 9000→9000; per vendor/admin in .env sulla VPS
